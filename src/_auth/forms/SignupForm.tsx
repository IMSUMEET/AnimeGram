...
const SignupForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof SignupValidation>) {
    ...
    console.log(typeof isUserLoading);
    console.log(typeof isSigningIn);
  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        <p className="text-light-3 small-medium md:base-regular mt-2">To use animegram please enter your details</p>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 w-full mt-4">
          ...
          <Button type="submit" className="shad-button_primary">
            {isCreatingAccount ? (
              <span className="flex-center gap-2" ><Loader/> Loading...</span> 
            ): "Sign up"}
          </Button>
